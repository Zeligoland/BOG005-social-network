...
Desde el inicio MigroRed se enfocó en tener al usuario como base para esta aplicación, es por eso que gracias a Test de usabilidad, feedback de nuestros Coaches y Compañeras pudimos lograr un diseño eficiente, con propósito y que se adapta a las necesidades de nuestros usuarios, a continuación nuestra aplicación en su diseño final:
